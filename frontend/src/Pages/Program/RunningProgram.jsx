...
const RunningProject = () => {
    // const runningProject = projectData.filter((item) => item.projectCategory == 'running program')
    ...
    return (
        <>
            <div className='relative w-full h-40 xl:h-96 md:h-60 overflow-hidden'>
                ...
                <div className='w-full text-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 pt-12 xl:pt-0 '>
            ...
            <div className='container py-4 xl:py-16 flex flex-col gap-8'>
                {data1.map((item) => (
